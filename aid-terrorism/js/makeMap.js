            ...
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              ...
              Promise.all(tables.map(function (table) {
                ...
                options.widgets.forEach(function (w, x) {
                  ...
                  if (!inputs.length) makeLayers_makeLayers(map);
                  var initialized = 0;
