...
function CustomMap(container, properties) {
  ...
  this.render = function() {
    ...
    if (!_this.hasOwnProperty('zoomslider') || _this.zoomslider) {
      ...
      _this.leaflet.addControl(window.zoomSlider)
    }
...
function handleLoadLeaflet() {
  return new Promise(function(resolve, reject) {
    let jsFiles = [
      'https://csis-ilab.github.io/map-templates/dist/js/vendor/polyfills.js',
      'https://csis-ilab.github.io/map-templates/dist/js/vendor/zoomslider.js',
      'https://csis-ilab.github.io/map-templates/dist/js/vendor/fullscreen.js',
      'https://unpkg.com/leaflet.markercluster@1.4.1/dist/leaflet.markercluster.js',
      'https://csis-ilab.github.io/map-templates/dist/js/vendor/chroma.js',
    ...
    jsFiles.forEach(function(file) {
      ...
      jsLink.onload = function() {
        ...
        if (leafletLoaded === jsFiles.length) {
...
async function importFiles() {
  return new Promise(function(resolve, reject) {
    ...
    let jsFiles = ['https://unpkg.com/leaflet@1.3.1/dist/leaflet.js']
    ...
    jsFiles.forEach(function(file) {
      ...
      jsLink.onload = handleLoadLeaflet

      head.appendChild(jsLink)
    })

    var scriptsLoaded = Array.from(document.querySelectorAll('head script'))
      .length
    ...
    return fetch(
      ...
      .then(function(json) {
        ...
        options.widgets.forEach(function(w, x) {
          ...
          // if (!inputs.length) makeGroups(map)
  ...
  map.json.forEach(function(json, i) {
    ...
    map.groups.push(
      new L.MarkerClusterGroup({
        ...
        maxClusterRadius: allPoints ? map.clusterdistance : 0,
